...
export class AssetLoader {
    ...
    loadCharacterSprites(): void {
        ...
        this.scene.load.atlas(
            ...
            'assets/sprites/chars/lanternbearer_walk.json'
        );
        ...
        this.scene.load.atlas(
            ...
            'assets/sprites/chars/lanternbearer_idle.json'
        );
        ...
        this.scene.load.atlas(
            ...
            'assets/sprites/chars/lanternbearer_cast.json'
        );
    }
     ...
     */
    loadSidekickSprites(): void {
        this.scene.load.atlas(
            'sidekick_idle',
            'assets/sprites/fx/sidekick_idle.png',
            'assets/sprites/fx/sidekick_idle.json'
        );
    }
    ...
    loadBossSprites(): void {
        ...
        this.scene.load.atlas(
            ...
            'assets/sprites/enemies/hourglass_wraith.json'
        );
        ...
        this.scene.load.atlas(
            ...
            'assets/sprites/enemies/shape_mimic.json'
        );
    }
