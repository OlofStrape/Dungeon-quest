...
export class OverworldScene extends Phaser.Scene {
  ...
  init(data: { dungeon: string; dungeonData: RoomRow[] }): void {
  ...
  private createDungeonRooms(): void {
  ...
  private createRoomVisuals(roomRow: RoomRow): void {
  ...
  private setupEventListeners(): void {
    ...
    this.events.on('roomComplete', (roomRow: RoomRow) => {
    ...
    // Trigger events
    this.events.on('triggerActivated', (data: any) => {
      this.handleTriggerActivated(data);
    });
  }

  private handleRoomComplete(roomRow: RoomRow): void {
  ...
  private handleRoomFail(roomRow: RoomRow): void {
  ...
  private handleTriggerActivated(data: any): void {
  ...
  private enterRoom(roomRow: RoomRow): void {
  ...
  private startBattle(roomRow: RoomRow): void {
  ...
  private showCompletionFeedback(roomRow: RoomRow): void {
